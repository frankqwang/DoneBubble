...
一天里消耗精力的事情，不只是一项需要长时间专注的任务。回复一条重要消息、在两个方案之间做决定、切换到另一个问题排查，都会让大脑重新建立上下文。频繁在不同事情之间切换，会消耗注意力、工作记忆和决策能力；人的精力有限，能够同时处理的事情也有限。

DoneBubble 记录的不是“还有多少事情没做”，而是**今天已经占用过多少注意力和决策精力**。轻量回复、小操作算作轻负荷；需要思考或沟通的事情算作中负荷；复杂决策、事故和长时间排查算作重负荷。这样，用户可以在不维护任务清单的情况下，看到一天中实际承受的事务负荷，并在负荷达到一定程度时提醒自己停下来休息。
