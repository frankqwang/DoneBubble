...
public sealed record ActivityContext(string Application, int ProcessId, string WindowTitle, string WindowClass, string? ExecutablePath, string? FocusedControl, string? FocusedText, TimeSpan Duration, DateTime CapturedAt, string RecentObservations = "")
{
